...
describe('Fragment Handling', () => {
    it('should define a named fragment', async () => {
        ...
        expect(result.data.message).toContain("Fragment 'userFragment' defined on type 'User' with 2 fields.");
    });
    ...
    it('should apply a named fragment', async () => {
        ...
        expect(result.success).toBe(true);
        expect(result.data.message).toContain("Fragment 'userFragment' applied at path 'user'.");
    });
    ...
    it('should apply an inline fragment', async () => {
        ...
        expect(result.success).toBe(true);
        expect(result.data.message).toContain("Inline fragment on type 'User' applied at path 'user' with 1 fields.");
    });
}); 